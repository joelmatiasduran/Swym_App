...
const SignUpFormScreen = ({ route }) => {
  ...
  //Function to get into WalkThrough Screen
  ...
  const onSignUpSubmitted = async ({ username, email, password }) => {
    //This variable changes the state of Value, and this activates the if statement that will decide
    //if the screens will appear or not to the new user
    setValue('I am a new user');
